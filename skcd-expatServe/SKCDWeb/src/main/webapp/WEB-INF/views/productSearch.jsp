...
<div class="row" >
  <div class="col-xs-12 col-md-3" ng-repeat="product in productNames | filter:searchProduct">
    <a href="#." class="thumbnail"  ng-click="openModal(product.porductId,product.productName,product.productDesc)">
      <img src="<c:url value="/resources/images/{{product.productImageName}}" />" alt="{{ product.productName }}">
        <div class="caption">
